...
public class BMICalculatorTest {
    ...
    @Test(dataProvider = "bmi_data")
     void testBMIWithDifferentInputs(String h, String w, String bmiResult) {
        ...
        height.sendKeys(h);
        weight.sendKeys(w);
        WebElement calculateBtn = myWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/main/section/div/article/div/div/form/fieldset/div[2]/div[1]/div[2]/div[4]/input")));
    ...
    @Test(dataProvider = "bmi_data")
    void testBMIWithDifferentInputs() {
